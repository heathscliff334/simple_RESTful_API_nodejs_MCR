...
exports.createData = (req, res) => {
    ...
    insertLanguages(req, res, queryGetId, queryInsert, data);
};
...
exports.updateData = (req, res) => {
    ...
    updateLanguages(req, res, findIdQuery, updateQuery, req.params.id, data);
};
exports.deleteData = (req, res) => {
    const findIdQuery = 'SELECT * FROM tb_languages WHERE id_language = ?';
    const deleteQuery = 'DELETE FROM tb_languages WHERE id_language = ?';
    deleteLanguages(req, res, findIdQuery, deleteQuery, req.params.id);
};