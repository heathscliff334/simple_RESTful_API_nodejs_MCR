...
exports.insertProjects = (response, getState, insertState, data) => {
    let tempId;
...
exports.updateProjects = (response, findIdStatement, updateStatement, id, data) => {
...
exports.deleteProjects = (response, findIdStatement, deleteStatement, id) => {
    conn.query(findIdStatement, id, (err, rows, field) => {
        if (err) {
            return responseError(response, 500, 'Failed to find the ID', err);
        }
