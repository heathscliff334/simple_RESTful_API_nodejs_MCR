...
exports.insertSkills = (request, response, getState, insertState, data) => {
...
exports.updateSkills = (request, response, findIdStatement, updateStatement, id, data) => {
    const verif = auth(request, response);
    if (verif.verified) {
...
exports.deleteSkills = (request, response, findIdStatement, deleteStatement, id) => {
    const verif = auth(request, response);
    if (verif.verified) {
        conn.query(findIdStatement, id, (err, rows, field) => {
            if (err) {
